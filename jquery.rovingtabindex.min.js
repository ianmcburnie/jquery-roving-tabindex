...
(function($,window,document,undefined){var pluginName='jquery-roving-tabindex';$.fn.rovingTabindex=function rovingTabindex(rovingItemsSelector,options){options=$.extend({activeIndex:0,autoFocus:true,autoInit:true,autoReset:false,axis:'both',isGrid:false,autoWrap:false},options);return this.each(function onEachMatchedEl(){var $widget=$(this);var $rovingItems=$widget.find(rovingItemsSelector);var numRovingItems=$rovingItems.length;function updateTabindex($fromEl,$toEl){$fromEl.removeAttr('tabindex');$toEl.attr('tabindex','0');}
